 ...
 */
package com.warpnet.warpnet-android.service
...
class AccountAuthenticatorService : Service() {
  ...
  private lateinit var authenticator: WarpnetAccountAuthenticator

  override fun onCreate() {
    super.onCreate()
    authenticator = WarpnetAccountAuthenticator(this)
  }
  ...
  private class WarpnetAccountAuthenticator(val context: Context) :
