...
import com.warpnet.warpnet-android.component.status.RoundAvatar
...
import com.warpnet.warpnet-android.model.ui.UiDMConversationWithLatestMessage
...
private fun UiDMEvent.resolveLink(
  ...
  return when {
    ...
    entity != null -> {
      if (entity.displayUrl.contains("pic.warpnet.com")) {
        ResolvedLink(
          expanded = resLoader.getString(com.warpnet.warpnet-android.MR.strings.scene_messages_expanded_photo),
          clickable = false
        )
      } else {
        ResolvedLink(
