 ...
 */
package com.warpnet.warpnet-android.component.lists
...
@Composable
fun WarpnetListsModifyComponent(
  name: String,
  desc: String,
  isPrivate: Boolean,
  ...
  Column(
    modifier = Modifier
      .fillMaxSize()
      .padding(WarpnetListsModifyComponentDefaults.PagePadding)
  ) {
    ...
    CompositionLocalProvider(LocalContentAlpha provides ContentAlpha.disabled) {
      Text(
        text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_modify_name),
        style = MaterialTheme.typography.caption,
        modifier = Modifier.padding(WarpnetListsModifyComponentDefaults.TextFieldTitle.ContentPadding)
      )
    }
    LaunchedEffect(true) {
    ...
    Spacer(modifier = Modifier.height(WarpnetListsModifyComponentDefaults.VerticalPadding))
    CompositionLocalProvider(LocalContentAlpha provides ContentAlpha.disabled) {
      Text(
        text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_modify_description),
        style = MaterialTheme.typography.caption,
        modifier = Modifier.padding(WarpnetListsModifyComponentDefaults.TextFieldTitle.ContentPadding)
      )
    }
    ...
    Row(
      ...
      Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_modify_private), style = MaterialTheme.typography.body1)
      ColoredSwitch(
        checked = isPrivate,
...
private object WarpnetListsModifyComponentDefaults {
