          ...
          CompositionLocalProvider(
            ...
            Row(
              ...
              StatusStatistics(
                ...
                icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_corner_up_left),
                contentDescription = stringResource(
                  res = com.warpnet.warpnet-android.MR.strings.scene_status_reply_mutiple,
              ...
              StatusStatistics(
                ...
                icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_repeat),
                contentDescription = stringResource(
                  res = com.warpnet.warpnet-android.MR.strings.scene_status_retweet_mutiple,
                  status.metrics.retweet,
                ),
              )
              if (status.platformType == PlatformType.Warpnet) {
                Spacer(modifier = Modifier.width(DetailedStatusDefaults.StatusStatisticsSpacing))
                StatusStatistics(
                  count = status.warpnetExtra?.quoteCount ?: 0,
                  icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_blockquote),
              ...
              StatusStatistics(
                ...
                icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_heart),
                contentDescription = stringResource(
                  res = com.warpnet.warpnet-android.MR.strings.scene_status_like_multiple,
                  status.metrics.like,
                ),
              )
            }
