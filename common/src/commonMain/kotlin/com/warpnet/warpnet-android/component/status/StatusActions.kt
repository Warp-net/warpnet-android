...
fun ReplyButton(
  ...
  val icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_corner_up_left)
...
fun LikeButton(
  ...
  val icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_heart)
  val data = remember(status) { status.retweet ?: status }
  if (withNumber) {
    StatusActionButtonWithNumbers(
      modifier = modifier,
...
fun RetweetButton(
  ...
  val icon = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_repeat)
