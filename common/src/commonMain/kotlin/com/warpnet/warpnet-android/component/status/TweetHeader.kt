...
fun RetweetHeader(
  ...
  TweetHeader(
    icon = {
      Icon(
        painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_repeat),
        contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_common_status_retweeted),
        tint = Color(0xFF4C9EEB)
      )
    },
    text = {
      if (data.platformType == PlatformType.Warpnet) {
        Text(
          stringResource(
            res = com.warpnet.warpnet-android.MR.strings.common_controls_status_user_retweeted,
