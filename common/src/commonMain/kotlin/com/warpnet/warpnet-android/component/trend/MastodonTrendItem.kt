 ...
 */
package com.warpnet.warpnet-android.component.trend
  ...
  Column {
    Row(
      ...
      ListItem(
        ...
        secondaryText = {
          Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_trends_accounts, trend.dailyAccounts), style = MaterialTheme.typography.body2)
        },
        text = {
