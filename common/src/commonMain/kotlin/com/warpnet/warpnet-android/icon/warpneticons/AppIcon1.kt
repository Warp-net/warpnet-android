 ...
 */
package com.warpnet.warpnet-android.icon.warpneticons
...
public val WarpnetIcons.AppIcon1: ImageVector
  get() {
    if (_appIcon1 != null) {
      return _appIcon1!!
    }
    _appIcon1 = Builder(
      ...
      group {
        path(
          ...
          stroke = SolidColor(Color(0xFFFFD4D4)),
        ...
        path(
          fill = SolidColor(Color(0xFF31303E)),
          stroke = null,
        ...
        path(
          fill = SolidColor(Color(0xFF4C9EEB)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
        ...
        path(
          ...
          curveTo(234.658f, 222.996f, 231.971f, 225.682f, 231.971f, 228.996f)
          curveTo(231.971f, 230.587f, 232.603f, 232.113f, 233.729f, 233.239f)
          lineTo(316.48f, 315.99f)
          curveTo(318.824f, 318.333f, 322.622f, 318.333f, 324.966f, 315.99f)
          lineTo(407.717f, 233.239f)
          curveTo(410.061f, 230.895f, 410.061f, 227.096f, 407.717f, 224.753f)
        ...
        path(
          fill = SolidColor(Color(0xFFFA541C)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
          ...
          curveTo(184.94f, 148.505f, 181.141f, 148.481f, 178.783f, 150.809f)
          curveTo(178.765f, 150.827f, 178.747f, 150.845f, 178.73f, 150.863f)
          close()
        }
        path(
          fill = SolidColor(Color(0xFF8D47EE)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
        ...
        path(
          fill = SolidColor(Color(0xFFFAAD14)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
...
private var _appIcon1: ImageVector? = null
