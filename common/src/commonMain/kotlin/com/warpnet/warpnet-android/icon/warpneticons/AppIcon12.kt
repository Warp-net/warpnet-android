...
public val WarpnetIcons.AppIcon12: ImageVector
  get() {
    if (_appIcon12 != null) {
      return _appIcon12!!
    }
    _appIcon12 = Builder(
      ...
      group {
        ...
        path(
          fill = SolidColor(Color(0xFF7F95B3)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
        ...
        path(
          fill = SolidColor(Color(0xFFBFCAD9)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
        ...
        path(
          fill = SolidColor(Color(0xFF9FAFC6)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
        ...
        path(
          fill = SolidColor(Color(0xFF8095B3)),
          stroke = null,
          strokeLineWidth = 0.0f,
          strokeLineCap = Butt,
          strokeLineJoin = Miter,
...
private var _appIcon12: ImageVector? = null
