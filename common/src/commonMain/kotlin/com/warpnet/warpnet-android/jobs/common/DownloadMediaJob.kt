...
import com.warpnet.warpnet-android.notification.StringNotificationEvent.Companion.show
...
class DownloadMediaJob(
  ...
  suspend fun execute(
    ...
    inAppNotification.show(resLoader.getString(com.warpnet.warpnet-android.MR.strings.common_controls_actions_save))
  }
}
