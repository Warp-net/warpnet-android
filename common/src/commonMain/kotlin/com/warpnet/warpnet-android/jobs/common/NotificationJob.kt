 ...
 */
package com.warpnet.warpnet-android.jobs.common
...
import com.warpnet.warpnet-android.notification.AppNotification
import com.warpnet.warpnet-android.notification.AppNotificationManager
import com.warpnet.warpnet-android.notification.NotificationChannelSpec
import com.warpnet.warpnet-android.notification.notificationChannelId
      ...
      PlatformType.Warpnet -> {
        NotificationData(
          title = resLoader.getString(
            com.warpnet.warpnet-android.MR.strings.common_notification_mentions,
            status.user.displayName
          ),
          htmlContent = status.htmlText,
          deepLink = RootDeepLinks.Warpnet.Status(status.statusId),
  ...
  private fun generateMastodonNotificationData(
    ...
    return when (status.mastodonExtra.type) {
      ...
      MastodonStatusType.NotificationFollow -> {
        NotificationData(
          title = resLoader.getString(
            com.warpnet.warpnet-android.MR.strings.common_notification_follow,
      ...
      MastodonStatusType.NotificationFollowRequest -> {
        NotificationData(
          title = resLoader.getString(
            com.warpnet.warpnet-android.MR.strings.common_notification_follow_request,
            actualStatus.user.displayName
          ),
          deepLink = RootDeepLinks.User(actualStatus.user.userKey)
        )
      ...
      MastodonStatusType.NotificationReblog -> {
        NotificationData(
          title = resLoader.getString(
            com.warpnet.warpnet-android.MR.strings.common_notification_reblog,
            actualStatus.user.displayName
          ),
          deepLink = RootDeepLinks.Status(actualStatus.statusKey),
          profileImage = actualStatus.user.profileImage,
      ...
      MastodonStatusType.NotificationFavourite -> {
        NotificationData(
          title = resLoader.getString(
            com.warpnet.warpnet-android.MR.strings.common_notification_favourite,
            actualStatus.user.displayName
          ),
          deepLink = RootDeepLinks.Status(actualStatus.statusKey),
          profileImage = actualStatus.user.profileImage,
      ...
      MastodonStatusType.NotificationPoll -> {
        NotificationData(
          title = resLoader.getString(
            com.warpnet.warpnet-android.MR.strings.common_notification_poll,
          ),
          deepLink = RootDeepLinks.Status(actualStatus.statusKey),
          profileImage = actualStatus.user.profileImage,
        )
