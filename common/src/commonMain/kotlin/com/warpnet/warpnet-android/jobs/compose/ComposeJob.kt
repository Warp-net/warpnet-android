...
abstract class ComposeJob<T : MicroBlogService>(
  ...
  suspend fun execute(composeData: ComposeData, accountKey: MicroBlogKey) {
    val builder = AppNotification
      ...
      .setContentTitle(resLoader.getString(com.warpnet.warpnet-android.MR.strings.common_alerts_tweet_sending_title))
      .setOngoing(true)
      .setSilent(true)
    ...
    try {
      ...
      builder.setOngoing(false)
        ...
        .setSilent(false)
        .setContentTitle(resLoader.getString(com.warpnet.warpnet-android.MR.strings.common_alerts_tweet_sent_title))
      ...
      builder.setOngoing(false)
        .setProgress(0, 0, false)
        .setSilent(false)
        .setContentTitle(resLoader.getString(com.warpnet.warpnet-android.MR.strings.common_alerts_tweet_fail_title))
