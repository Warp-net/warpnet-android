...
class DirectMessageFetchJob(
  ...
  private fun notification(account: AccountDetails, message: UiDMConversationWithLatestMessage) {
    val builder = AppNotification
      ...
      .setContentTitle(resLoader.getString(com.warpnet.warpnet-android.MR.strings.common_notification_messages_title))
      .setContentText(
        resLoader.getString(
          com.warpnet.warpnet-android.MR.strings.common_notification_messages_content,
