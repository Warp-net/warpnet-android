...
import com.warpnet.warpnet-android.kmp.MediaSize
  ...
  suspend fun execute(sendData: DirectMessageSendData, accountKey: MicroBlogKey) {
    ...
    try {
      ...
      images.forEach { uri ->
        ...
        // TODO FIXME 2020/6/30 Warpnet DM throws bad media error after remove exif data from images
        //
      ...
      val builder = AppNotification
        ...
        .setContentTitle(resLoader.getString(com.warpnet.warpnet-android.MR.strings.common_alerts_failed_to_send_message_message))
