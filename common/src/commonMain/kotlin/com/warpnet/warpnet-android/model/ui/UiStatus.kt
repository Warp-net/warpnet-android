...
import com.warpnet.warpnet-android.extensions.formattedTimestamp
import com.warpnet.warpnet-android.extensions.humanizedCount
import com.warpnet.warpnet-android.extensions.humanizedTimestamp
...
data class UiStatus(
  ...
  companion object {
    ...
    fun sample() = UiStatus(
      statusId = "",
      htmlText = autolink.autoLink(stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_display_preview_thank_for_using_warpnet_x)),
