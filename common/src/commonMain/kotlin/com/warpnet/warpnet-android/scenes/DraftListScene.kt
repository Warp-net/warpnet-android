    ...
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          ...
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_drafts_title))
          }
        )
      }
    ) {
          ...
          Box {
            ...
            DropdownMenu(
              ...
              DropdownMenuItem(
                ...
                Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_drafts_actions_edit_draft))
              }
              DropdownMenuItem(
                onClick = {
                  viewModel.delete(it)
