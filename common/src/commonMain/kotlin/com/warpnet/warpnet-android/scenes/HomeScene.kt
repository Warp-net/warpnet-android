...
import com.warpnet.warpnet-android.component.UserMetrics
import com.warpnet.warpnet-android.component.foundation.AppBar
import com.warpnet.warpnet-android.component.foundation.AppBarDefaults
import com.warpnet.warpnet-android.component.foundation.ApplyNotification
import com.warpnet.warpnet-android.component.foundation.IconTabsComponent
import com.warpnet.warpnet-android.component.foundation.InAppNotificationScaffold
import com.warpnet.warpnet-android.component.foundation.NestedScrollScaffold
...
import com.warpnet.warpnet-android.component.lazy.divider
...
import com.warpnet.warpnet-android.scenes.home.item
...
private fun EmptyColumnHomeContent(
  ...
  InAppNotificationScaffold(
    ...
    Column(
      ...
      Icon(
        painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_empty_column),
          ...
          item {
            ListItem(
              ...
              text = {
                Text(
                  text = stringResource(
                    res = com.warpnet.warpnet-android.MR.strings.scene_drawer_sign_in
                  )
                )
              }
            )
          ...
          item {
            ListItem(
              ...
              text = {
                Text(
                  text = stringResource(
                    res = com.warpnet.warpnet-android.MR.strings.scene_manage_accounts_title
                  )
                )
              }
            )
      ...
      icon = {
        Icon(
          painter = painterResource(
            res = com.warpnet.warpnet-android.MR.files.ic_adjustments_horizontal
          ),
          contentDescription = stringResource(
            res = com.warpnet.warpnet-android.MR.strings.scene_settings_title
          ),
          modifier = Modifier.size(24.dp),
        )
      },
    ...
    trailing = {
      ...
      IconButton(
        ...
        Icon(
          ...
          contentDescription = stringResource(
            res = com.warpnet.warpnet-android.MR.strings.accessibility_scene_home_drawer_account_dropdown
          ),
        )
      }
    }
