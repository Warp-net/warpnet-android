...
import com.warpnet.warpnet-android.component.status.DetailedStatusComponent
  ...
  WarpnetScene {
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_tabs_tweets))
          },
          navigationIcon = {
