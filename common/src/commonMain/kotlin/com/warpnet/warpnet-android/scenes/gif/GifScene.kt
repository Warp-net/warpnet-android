 ...
 */
package com.warpnet.warpnet-android.scenes.gif
...
import com.warpnet.warpnet-android.component.lazy.ui.LazyUiGifList
    ...
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          ...
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_scene_gif_title))
          },
          actions = {
            IconButton(
              onClick = {
              ...
              Icon(
                ...
                contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.common_controls_actions_yes),
...
private fun SearchInput(
  ...
  Row(
    ...
    TextInput(
      ...
      placeholder = {
        Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_scene_gif_search))
      },
      maxLines = 1,
