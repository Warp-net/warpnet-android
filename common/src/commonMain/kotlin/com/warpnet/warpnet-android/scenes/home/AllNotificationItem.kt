...
class AllNotificationItem : HomeNavigationItem() {
  ...
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_notification_tabs_all)
  }
  ...
  WarpnetScene {
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_notification_tabs_all))
          },
          navigationIcon = {
