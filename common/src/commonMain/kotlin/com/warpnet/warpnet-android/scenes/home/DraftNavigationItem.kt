...
import com.warpnet.warpnet-android.scenes.DraftListSceneContent
import moe.tlaster.precompose.navigation.Navigator

class DraftNavigationItem : HomeNavigationItem() {
  @Composable
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_drafts_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnet-android.MR.files.ic_note)
  }
