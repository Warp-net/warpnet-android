...
import com.warpnet.warpnet-android.scenes.lists.ListsSceneContent
import com.warpnet.warpnet-android.scenes.lists.ListsSceneFab
import moe.tlaster.precompose.navigation.Navigator

class ListsNavigationItem : HomeNavigationItem() {
  @Composable
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnet-android.MR.files.ic_lists)
  }
