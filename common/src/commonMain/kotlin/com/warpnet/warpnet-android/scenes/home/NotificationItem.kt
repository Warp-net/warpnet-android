...
class NotificationItem : HomeNavigationItem() {
  @Composable
  override fun name(): String = stringResource(com.warpnet.warpnet-android.MR.strings.scene_notification_title)
  override val route: String
    get() = Root.Notification

  @Composable
  override fun icon(): Painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_message_circle)
  ...
  WarpnetScene {
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_mentions_title))
          },
          navigationIcon = {
