...
import com.warpnet.warpnet-android.component.navigation.hashtag
import com.warpnet.warpnet-android.component.navigation.search
import com.warpnet.warpnet-android.component.navigation.searchInput
import com.warpnet.warpnet-android.component.painterResource
import com.warpnet.warpnet-android.component.stringResource
import com.warpnet.warpnet-android.component.trend.MastodonTrendItem
import com.warpnet.warpnet-android.component.trend.WarpnetTrendItem
...
import com.warpnet.warpnet-android.scenes.home.presenter.SearchItemState
import com.warpnet.warpnet-android.scenes.home.presenter.TrendingPresenter
...
class SearchItem : HomeNavigationItem() {
  ...
  @Composable
  override fun name(): String = stringResource(com.warpnet.warpnet-android.MR.strings.scene_search_title)
  override val route: String
    get() = Root.Search.Home

  @Composable
  override fun icon(): Painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_search)
  ...
  WarpnetScene {
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_title))
          },
          navigationIcon = {
            ...
            Row(
              ...
              CompositionLocalProvider(
                ...
                Text(
                  ...
                  text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_search_bar_placeholder),
                )
              }
              IconButton(
                onClick = {
      ...
      if (state.searchInputState is SearchInputState.Data) {
        item {
          if (state.searchInputState.savedSource.isNotEmpty()) ListItem {
            Text(
              text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_saved_search),
          ...
          ListItem(
            ...
            trailing = {
              IconButton(
                ...
                Icon(
                  painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_trash_can),
                  contentDescription = stringResource(
                    res = com.warpnet.warpnet-android.MR.strings.common_controls_actions_remove
                  ),
                  modifier = Modifier.size(24.dp),
                )
              }
          ...
          if (state.searchInputState.showExpand) ListItem(
            ...
            Text(
              text = if (state.searchInputState.expandSearch) {
                stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_show_less)
              } else {
                stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_show_more)
              },
              style = MaterialTheme.typography.subtitle1,
            ...
            ListItem {
              when (account.type) {
                PlatformType.Warpnet ->
                  Text(
                    text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_trends_world_wide),
                    style = MaterialTheme.typography.button
                  )
