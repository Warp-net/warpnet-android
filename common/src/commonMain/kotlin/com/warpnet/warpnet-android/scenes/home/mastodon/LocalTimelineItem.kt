...
class LocalTimelineItem : HomeNavigationItem() {
  ...
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_local_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnet-android.MR.files.ic_users)
  }
