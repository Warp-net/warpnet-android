              ...
              navigationIcon = {
                IconButton(
                  ...
                  Icon(
                    ...
                    contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_common_back)
                  )
                }
              },
              title = {
                Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_users_add_title))
              },
              elevation = 0.dp,
            )
            Row(
              ...
              Icon(
                ...
                contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_search_title),
                modifier = Modifier.padding(ListsAddMembersSceneDefaults.SearchInput.Icon.Padding).size(24.dp),
              )
              TextInput(
                value = keyword,
                placeholder = {
                  Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_users_add_search))
                },
                onValueChange = {
    ...
    LazyUiUserList(
      ...
      action = {
        TextButton(
          ...
          if (pending) {
            Text(
              text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_users_menu_actions_remove),
              style = MaterialTheme.typography.button,
              color = Color(0xFFFF3B30),
            )
          } else {
            Text(
              text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_lists_users_menu_actions_add),
              style = MaterialTheme.typography.button,
