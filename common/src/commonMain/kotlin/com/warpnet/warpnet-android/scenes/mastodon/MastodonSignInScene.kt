    ...
    if (loading) {
      ...
      SignInButton(
        ...
        ListItem(
          icon = {
            Icon(
              painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_mastodon_logo_white),
          ...
          text = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_sign_in_sign_in_with_mastodon))
          },
          trailing = {
            IconButton(
              enabled = false,
