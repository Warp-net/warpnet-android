...
import com.warpnet.warpnet-android.component.foundation.ParallaxLayout
import com.warpnet.warpnet-android.component.foundation.rememberParallaxLayoutState
    ...
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          ...
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_about_title))
          }
        )
      }
    ) {
  ...
  Column(
    ...
    Box(
      ...
      ParallaxLayout(
        ...
        backContent = {
          Image(
            painter = painterResource(com.warpnet.warpnet-android.MR.files.ic_about_gray_logo_shadow),
            contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_about_logo_background_shadow),
            modifier = Modifier
              .blur(30.dp)
        ...
        Image(
          painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_about_gray_logo),
          contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_about_logo_background),
          modifier = Modifier
            .aspectRatio(aspectRatio)
            .fillMaxHeight()
            .padding(
      ...
      Column(
        ...
        Text(
          text = stringResource(
            res = com.warpnet.warpnet-android.MR.strings.scene_settings_about_version,
        ...
        CompositionLocalProvider(LocalContentAlpha provides ContentAlpha.medium) {
          Text(
            text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_about_description),
    ...
    Row(
      ...
      Row {
        IconButton(
          ...
          Icon(
            painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_warpnet),
            tint = MaterialTheme.colors.onBackground,
            contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_common_logo_warpnet),
        ...
        IconButton(
          ...
          Icon(
            painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_github),
            tint = MaterialTheme.colors.onBackground,
            contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_common_logo_github),
            modifier = Modifier.size(24.dp),
          )
        }
        Box(modifier = Modifier.width(AboutContentDefaults.Icon.Spacing))
        IconButton(
          ...
          Icon(
            painter = painterResource(res = com.warpnet.warpnet-android.MR.files.ic_telegram),
            tint = MaterialTheme.colors.onBackground,
            contentDescription = stringResource(res = com.warpnet.warpnet-android.MR.strings.accessibility_common_logo_github),
            modifier = Modifier.size(24.dp),
          )
      ...
      TextButton(
        ...
        Column(
          ...
          Text(
            text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_about_license),
