...
import com.warpnet.warpnet-android.component.foundation.ReorderableColumn
import com.warpnet.warpnet-android.component.foundation.rememberReorderableColumnState
    ...
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          ...
          title = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_layout_title))
          }
        )
      }
    ) {
      Column(
        ...
        ListItem(
          text = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_layout_desc_title))
          },
          secondaryText = {
            Text(text = stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_layout_desc_content))
          }
        )
        ReorderableColumn(
          data = state.menus,
  ...
  when (it) {
    is Boolean -> {
      ItemHeader {
        Text(
          text = if (it) {
            stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_layout_actions_tabbar)
          } else {
            stringResource(res = com.warpnet.warpnet-android.MR.strings.scene_settings_layout_actions_drawer)
          }
        )
      }
    }
            ...
            IconButton(
              ...
              Image(
                painter = painterResource(
                  res = if (visible) {
                    com.warpnet.warpnet-android.MR.files.ic_delete_colored
                  } else {
                    com.warpnet.warpnet-android.MR.files.ic_add_colored
                  }
                ),
