...
import com.warpnet.warpnetandroid.component.foundation.loading
  ...
  when (state) {
    ...
    is LoadState.Error -> item {
      ListItem(
        ...
        text = {
//                        Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.list_load_state_error))
        }
      )
    }
    else -> {
