...
import com.warpnet.warpnetandroid.component.status.RoundAvatar
  ...
  return when {
    ...
    entity != null -> {
      if (entity.displayUrl.contains("pic.warpnet.com")) {
        ResolvedLink(
          expanded = resLoader.getString(com.warpnet.warpnetandroid.MR.strings.scene_messages_expanded_photo),
          clickable = false
        )
      } else {
        ResolvedLink(
