...
import com.warpnet.warpnetandroid.action.SwipeActionContainer
...
import com.warpnet.warpnetandroid.component.placeholder.UiStatusPlaceholder
import com.warpnet.warpnetandroid.component.status.StatusDivider
import com.warpnet.warpnetandroid.component.status.StatusThreadStyle
...
private fun LoadMoreButton(onClick: () -> Unit) {
  Box(
    ...
    Text(
      ...
      text = stringResource(
        res = com.warpnet.warpnetandroid.MR.strings.common_controls_timeline_load_more
      ),
...
private fun EmptyStatusList() {
  Column(
    ...
    Icon(
      painter = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_empty_status),
      contentDescription = stringResource(res = com.warpnet.warpnetandroid.MR.strings.common_alerts_no_tweets_found_title),
      modifier = Modifier.size(24.dp),
    )
    Spacer(modifier = Modifier.height(EmptyStatusListDefaults.VerticalPadding))
    CompositionLocalProvider(LocalContentAlpha provides ContentAlpha.disabled) {
      Text(
        text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.common_alerts_no_tweets_found_title),
