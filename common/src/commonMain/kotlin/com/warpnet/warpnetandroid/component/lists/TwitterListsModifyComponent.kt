 ...
 */
package com.warpnet.warpnetandroid.component.lists
...
fun WarpnetListsModifyComponent(
  ...
  Column(
    ...
    CompositionLocalProvider(LocalContentAlpha provides ContentAlpha.disabled) {
      Text(
        text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_lists_modify_name),
    ...
    CompositionLocalProvider(LocalContentAlpha provides ContentAlpha.disabled) {
      Text(
        text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_lists_modify_description),
        style = MaterialTheme.typography.caption,
        modifier = Modifier.padding(WarpnetListsModifyComponentDefaults.TextFieldTitle.ContentPadding)
      )
    }
    ...
    Row(
      ...
      Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_lists_modify_private), style = MaterialTheme.typography.body1)
      ColoredSwitch(
        checked = isPrivate,
