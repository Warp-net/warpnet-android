          ...
          CompositionLocalProvider(
            ...
            Row(
              ...
              StatusStatistics(
                ...
                icon = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_corner_up_left),
                contentDescription = stringResource(
                  res = com.warpnet.warpnetandroid.MR.strings.scene_status_reply_mutiple,
              ...
              StatusStatistics(
                ...
                icon = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_repeat),
                contentDescription = stringResource(
                  res = com.warpnet.warpnetandroid.MR.strings.scene_status_retweet_mutiple,
              ...
              if (status.platformType == PlatformType.Warpnet) {
                ...
                StatusStatistics(
                  ...
                  icon = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_blockquote),
              ...
              StatusStatistics(
                ...
                icon = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_heart),
                contentDescription = stringResource(
                  res = com.warpnet.warpnetandroid.MR.strings.scene_status_like_multiple,
                  status.metrics.like,
                ),
              )
            }
