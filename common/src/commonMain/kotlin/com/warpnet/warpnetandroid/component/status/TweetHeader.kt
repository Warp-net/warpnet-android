...
fun RetweetHeader(
  ...
  TweetHeader(
    icon = {
      Icon(
        painter = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_repeat),
        contentDescription = stringResource(res = com.warpnet.warpnetandroid.MR.strings.accessibility_common_status_retweeted),
    ...
    text = {
      if (data.platformType == PlatformType.Warpnet) {
        Text(
          stringResource(
            res = com.warpnet.warpnetandroid.MR.strings.common_controls_status_user_retweeted,
