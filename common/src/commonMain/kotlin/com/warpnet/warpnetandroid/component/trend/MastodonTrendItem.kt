 ...
 */
package com.warpnet.warpnetandroid.component.trend
  ...
  Column {
    Row(
      ...
      ListItem(
        ...
        secondaryText = {
          Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_trends_accounts, trend.dailyAccounts), style = MaterialTheme.typography.body2)
        },
        text = {
