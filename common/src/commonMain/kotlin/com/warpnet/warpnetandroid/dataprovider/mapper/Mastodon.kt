 ...
 */
package com.warpnet.warpnetandroid.dataprovider.mapper
...
import com.warpnet.services.mastodon.model.NotificationTypes
...
import com.warpnet.warpnetandroid.model.ui.Option
import com.warpnet.warpnetandroid.model.ui.StatusMetrics
import com.warpnet.warpnetandroid.model.ui.UiCard
import com.warpnet.warpnetandroid.model.ui.UiGeo
...
import com.warpnet.warpnetandroid.model.ui.UiTrendHistory
import com.warpnet.warpnetandroid.model.ui.UiUser
import com.warpnet.warpnetandroid.model.ui.UserMetrics
import com.warpnet.warpnetandroid.model.ui.mastodon.Field
import com.warpnet.warpnetandroid.model.ui.mastodon.MastodonMention
import com.warpnet.warpnetandroid.model.ui.mastodon.MastodonStatusExtra
import com.warpnet.warpnetandroid.model.ui.mastodon.MastodonUserExtra
  ...
  return UiStatus(
    ...
    media = (mediaAttachments ?: emptyList()).mapIndexed { index, it ->
      UiMedia(
        ...
        type = it.type?.let {
          when (it) {
            com.warpnet.services.mastodon.model.MediaType.image -> MediaType.photo
            com.warpnet.services.mastodon.model.MediaType.unknown -> MediaType.other
            com.warpnet.services.mastodon.model.MediaType.gifv -> MediaType.video
            com.warpnet.services.mastodon.model.MediaType.video -> MediaType.video
            com.warpnet.services.mastodon.model.MediaType.audio -> MediaType.audio
          }
        } ?: MediaType.photo,
        order = index,
      )
