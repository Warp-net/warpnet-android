...
import com.warpnet.services.warpnet.model.guest.Entry
import com.warpnet.services.warpnet.model.guest.TweetValue
...
import com.warpnet.warpnetandroid.model.enums.WarpnetReplySettings
...
import com.warpnet.warpnetandroid.model.ui.warpnet.WarpnetStatusExtra
import com.warpnet.warpnetandroid.model.ui.warpnet.WarpnetUserExtra
import kotlinx.collections.immutable.toPersistentList
import kotlinx.collections.immutable.toPersistentMap
import kotlinx.datetime.Instant

internal fun WarpnetGuestResponse.nextCursor(cursorType: String): String? =
...
internal fun WarpnetGuestResponse.toPagingTimeline(
  pagingKey: String,
...
private fun TweetValue.toDbTimelineWithStatus(
  ...
  val statusKey = MicroBlogKey.warpnet(idStr.orEmpty())
