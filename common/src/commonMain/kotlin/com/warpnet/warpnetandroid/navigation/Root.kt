...
import com.warpnet.warpnetandroid.scenes.HomeScene
import com.warpnet.warpnetandroid.scenes.StatusScene
import com.warpnet.warpnetandroid.scenes.search.SearchScene
import com.warpnet.warpnetandroid.scenes.warpnet.user.WarpnetUserScene
...
object Root {
  ...
  object Media {
    ...
    object Raw {
      ...
      operator fun invoke(type: com.warpnet.warpnetandroid.model.enums.MediaType, url: String) = "/Root/Media/Raw/$type/${java.net.URLEncoder.encode(url, "UTF-8")}"
    }
    object Pure {
  ...
  object Compose {
    object Home {
      ...
      operator fun invoke(composeType: com.warpnet.warpnetandroid.model.enums.ComposeType?, statusKey: MicroBlogKey?) = "/Root/Compose/Home?composeType=$composeType&statusKey=$statusKey"
    }
    object Search {
