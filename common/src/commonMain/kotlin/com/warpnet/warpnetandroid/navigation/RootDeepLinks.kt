...
object RootDeepLinks {
  ...
  object User {
    ...
    operator fun invoke(userKey: com.warpnet.warpnetandroid.model.MicroBlogKey) = "$warpnetXSchema://RootDeepLinks/User/$userKey"
  }
  object Status {
    const val route = "$warpnetXSchema://RootDeepLinks/Status/{statusKey}"
    operator fun invoke(statusKey: com.warpnet.warpnetandroid.model.MicroBlogKey) = "$warpnetXSchema://RootDeepLinks/Status/$statusKey"
  }
  object Search {
  ...
  object Compose {
    ...
    operator fun invoke(composeType: com.warpnet.warpnetandroid.model.enums.ComposeType?, statusKey: com.warpnet.warpnetandroid.model.MicroBlogKey?) = "$warpnetXSchema://RootDeepLinks/Compose?composeType=$composeType&statusKey=$statusKey"
  }
  object Conversation {
    const val route = "$warpnetXSchema://RootDeepLinks/Conversation/{conversationKey}"
    operator fun invoke(conversationKey: com.warpnet.warpnetandroid.model.MicroBlogKey) = "$warpnetXSchema://RootDeepLinks/Conversation/$conversationKey"
  }
  object Callback {
    object SignIn {
