...
import com.warpnet.warpnetandroid.component.foundation.SignInButton
...
private fun MastodonSignIn(
  ...
  SignInButton(
    ...
    ListItem(
      icon = {
        Icon(
          painter = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_mastodon_logo_blue),
          contentDescription = stringResource(
            res = com.warpnet.warpnetandroid.MR.strings.accessibility_common_logo_mastodon
          ),
      ...
      text = {
        Text(
          text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_sign_in_sign_in_with_mastodon)
        )
      },
      trailing = {
        IconButton(
          ...
          Icon(
            ...
            contentDescription = stringResource(
              res = com.warpnet.warpnetandroid.MR.strings.scene_sign_in_sign_in_with_mastodon
            )
          )
        }
      }
...
private fun WarpnetSignIn(
  ...
  SignInButton(
    ...
    ListItem(
      icon = {
        Icon(
          painter = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_warpnet_logo_white),
          contentDescription = stringResource(
            res = com.warpnet.warpnetandroid.MR.strings.accessibility_common_logo_warpnet
          ),
          modifier = Modifier.size(24.dp),
        )
      },
      text = {
        Text(
          text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_sign_in_sign_in_with_warpnet)
        )
      },
      trailing = if (currentPlatform == Platform.Android) {
        {
          IconButton(
            ...
            Icon(
              ...
              contentDescription = stringResource(res = com.warpnet.warpnetandroid.MR.strings.accessibility_common_more)
            )
          }
        }
      } else {
