...
import com.warpnet.warpnetandroid.component.foundation.ErrorPlaceholder
import com.warpnet.warpnetandroid.component.foundation.InAppNotificationScaffold
import com.warpnet.warpnetandroid.component.status.DetailedStatusComponent
...
import com.warpnet.warpnetandroid.utils.generateNotificationEvent
  ...
  WarpnetScene {
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          title = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_search_tabs_tweets))
          },
          navigationIcon = {
