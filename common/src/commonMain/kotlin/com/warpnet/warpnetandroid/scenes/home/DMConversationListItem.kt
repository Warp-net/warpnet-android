...
import com.warpnet.warpnetandroid.scenes.dm.DMConversationListSceneContent
import com.warpnet.warpnetandroid.scenes.dm.DMConversationListSceneFab
import moe.tlaster.precompose.navigation.Navigator

class DMConversationListItem : HomeNavigationItem() {
  @Composable
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_messages_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_mail)
  }
