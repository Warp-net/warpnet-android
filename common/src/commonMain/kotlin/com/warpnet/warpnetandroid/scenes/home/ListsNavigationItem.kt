...
import com.warpnet.warpnetandroid.scenes.lists.ListsSceneContent
import com.warpnet.warpnetandroid.scenes.lists.ListsSceneFab
import moe.tlaster.precompose.navigation.Navigator

class ListsNavigationItem : HomeNavigationItem() {
  @Composable
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_lists_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_lists)
  }
