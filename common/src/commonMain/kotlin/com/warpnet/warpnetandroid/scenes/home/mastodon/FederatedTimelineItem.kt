...
class FederatedTimelineItem : HomeNavigationItem() {
  ...
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_federated_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_globe)
  }
