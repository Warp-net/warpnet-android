...
import com.warpnet.warpnetandroid.component.foundation.TextTabsComponent
...
import com.warpnet.warpnetandroid.scenes.home.AllNotificationItem
import com.warpnet.warpnetandroid.scenes.home.MentionItem
...
class MastodonNotificationItem : HomeNavigationItem() {
  ...
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_notification_title)
  }
  ...
  override fun icon(): Painter {
    return painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_bell)
  }
  ...
  WarpnetScene {
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          title = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_notification_title))
          },
          navigationIcon = {
