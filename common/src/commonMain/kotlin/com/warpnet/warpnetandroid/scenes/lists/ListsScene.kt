...
import com.warpnet.warpnetandroid.component.lazy.ui.LazyUiListsList
    ...
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          ...
          title = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_lists_title))
          },
        )
      },
...
fun ListsSceneFab(
  ...
  FloatingActionButton(
    ...
    Row(
      ...
      Text(
        text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_lists_modify_create_title)
