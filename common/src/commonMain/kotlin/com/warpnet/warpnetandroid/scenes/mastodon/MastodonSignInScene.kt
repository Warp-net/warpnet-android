    ...
    if (loading) {
      ...
      SignInButton(
        ...
        ListItem(
          icon = {
            Icon(
              painter = painterResource(res = com.warpnet.warpnetandroid.MR.files.ic_mastodon_logo_white),
          ...
          text = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_sign_in_sign_in_with_mastodon))
          },
          trailing = {
            IconButton(
              enabled = false,
