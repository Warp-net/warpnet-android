          ...
          title = {
            ProvideTextStyle(value = MaterialTheme.typography.body1) {
              TextInput(
                ...
                maxLines = 1,
                placeholder = {
                  Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_search_search_bar_placeholder))
                },
                autoFocus = true,
          ...
          ListItem(
            ...
            icon = {
              Icon(
                ...
                contentDescription = stringResource(
                  res = com.warpnet.warpnetandroid.MR.strings.accessibility_scene_search_history
                )
              )
            },
            trailing = {
