...
import com.warpnet.warpnetandroid.scenes.search.tabs.presenter.SearchTweetsPresenter
import com.warpnet.warpnetandroid.scenes.search.tabs.presenter.SearchTweetsState
import moe.tlaster.precompose.navigation.Navigator

class SearchTweetsItem : SearchSceneItem {
  @Composable
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_search_tabs_tweets)
  }
