...
import com.warpnet.warpnetandroid.scenes.search.tabs.presenter.SearchUserPresenter
import com.warpnet.warpnetandroid.scenes.search.tabs.presenter.SearchUserState
import moe.tlaster.precompose.navigation.Navigator

class SearchUserItem : SearchSceneItem {
  @Composable
  override fun name(): String {
    return stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_search_tabs_users)
  }
