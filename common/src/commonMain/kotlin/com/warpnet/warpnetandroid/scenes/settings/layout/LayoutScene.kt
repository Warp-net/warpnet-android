 ...
 */
package com.warpnet.warpnetandroid.scenes.settings.layout
...
import com.warpnet.warpnetandroid.component.foundation.ReorderableColumn
import com.warpnet.warpnetandroid.component.foundation.rememberReorderableColumnState
    ...
    InAppNotificationScaffold(
      topBar = {
        AppBar(
          ...
          title = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_layout_title))
          }
        )
      }
    ) {
      Column(
        ...
        ListItem(
          text = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_layout_desc_title))
          },
          secondaryText = {
            Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_layout_desc_content))
          }
        )
        ReorderableColumn(
          data = state.menus,
  ...
  when (it) {
    is Boolean -> {
      ItemHeader {
        Text(
          text = if (it) {
            stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_layout_actions_tabbar)
          } else {
            stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_layout_actions_drawer)
          }
        )
      }
    }
            ...
            IconButton(
              ...
              Image(
                painter = painterResource(
                  res = if (visible) {
                    com.warpnet.warpnetandroid.MR.files.ic_delete_colored
                  } else {
                    com.warpnet.warpnetandroid.MR.files.ic_add_colored
                  }
                ),
