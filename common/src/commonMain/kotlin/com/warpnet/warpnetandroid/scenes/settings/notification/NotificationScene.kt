      ...
      Column {
        Surface(
          ...
          ListItem(
            ...
            text = {
              Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_notification_notification_switch))
            },
            trailing = {
              ColoredSwitch(
        ...
        ItemHeader {
          Text(text = stringResource(res = com.warpnet.warpnetandroid.MR.strings.scene_settings_notification_accounts))
        }
        LazyColumn {
          items(accounts) {
            val user = remember {
