...
import com.warpnet.warpnetandroid.component.NativeInsetsColor
import com.warpnet.warpnetandroid.component.NativeInsetsControl
import com.warpnet.warpnetandroid.component.PlatformInsets
import com.warpnet.warpnetandroid.extensions.withElevation
import com.warpnet.warpnetandroid.kmp.ProvideOverScrollConfiguration
import com.warpnet.warpnetandroid.kmp.isAndroidLessOreo
...
fun WarpnetScene(
  ...
  WarpnetTheme(darkTheme = darkTheme) {
...
private fun provideTypography(): Typography {
  ...
  val baseTypography = Typography()
    // classical text rendering (like the old warpnet)
    .let {
      it.copy(
