...
import com.warpnet.services.http.Errors
import com.warpnet.services.http.HttpClientFactory
import com.warpnet.services.http.MicroBlogNotFoundException
...
import com.warpnet.services.warpnet.api.WarpnetResources
import com.warpnet.services.warpnet.api.UploadResources
import com.warpnet.services.warpnet.model.Attachment
import com.warpnet.services.warpnet.model.BlockV2Request
import com.warpnet.services.warpnet.model.DirectMessageEvent
import com.warpnet.services.warpnet.model.DirectMessageEventObject
import com.warpnet.services.warpnet.model.MessageCreate
import com.warpnet.services.warpnet.model.MessageData
import com.warpnet.services.warpnet.model.MessageTarget
import com.warpnet.services.warpnet.model.PostTweetRequestV2
import com.warpnet.services.warpnet.model.PurpleMedia
import com.warpnet.services.warpnet.model.StatusV2
import com.warpnet.services.warpnet.model.WarpnetPaging
import com.warpnet.services.warpnet.model.WarpnetSearchResponseV1
import com.warpnet.services.warpnet.model.WarpnetSearchResponseV2
...
import com.warpnet.services.warpnet.model.fields.Expansions
import com.warpnet.services.warpnet.model.fields.MediaFields
import com.warpnet.services.warpnet.model.fields.PlaceFields
import com.warpnet.services.warpnet.model.fields.PollFields
import com.warpnet.services.warpnet.model.fields.TweetFields
import com.warpnet.services.warpnet.model.fields.UserFields
import com.warpnet.services.warpnet.model.request.WarpnetReactionRequestBody
import com.warpnet.services.utils.await
import com.warpnet.services.utils.copyToInLength
...
class WarpnetService(
  ...
  private val resources: WarpnetResources
    get() = httpClientFactory.createResources(
      clazz = WarpnetResources::class.java,
      baseUrl = WARPNET_BASE_URL,
  ...
  private val uploadResources: UploadResources
    get() = httpClientFactory.createResources(
      ...
      baseUrl = UPLOAD_WARPNET_BASE_URL,
      authorization = createOAuth1Authorization(),
      useCache = true
    )
  ...
  override suspend fun lookupStatus(id: String): StatusV2 {
    ...
    val data = response.data ?: throw WarpnetApiException("Status not found")
  ...
  override suspend fun like(id: String): IStatus {
    return try {
      resources.likeV2(userId = accountId, body = WarpnetReactionRequestBody(tweet_id = id))
        .run {
          lookupStatus(id)
        }
    } catch (e: WarpnetApiExceptionV2) {
  ...
  override suspend fun retweet(id: String): IStatus {
    return try {
      resources.retweetV2(userId = accountId, body = WarpnetReactionRequestBody(tweet_id = id))
        .run {
          lookupStatus(id)
        }
    } catch (e: WarpnetApiExceptionV2) {
  ...
  override suspend fun followers(user_id: String, nextPage: String?) = resources.followers(
    ...
    WarpnetPaging(it.data ?: emptyList(), it.meta?.nextToken)
  }
