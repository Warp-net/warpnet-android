...
import com.warpnet.services.warpnet.model.PostTweetResponse
import com.warpnet.services.warpnet.model.Status
import com.warpnet.services.warpnet.model.StatusReactionsV2
...
interface StatusResources {
  ...
  ): WarpnetResponseV2<PostTweetResponse>

  @POST("/1.1/statuses/destroy/{id}.json")
  suspend fun destroy(@Path(value = "id") id: String): Status

  @POST("/2/users/{userId}/retweets")
  suspend fun retweetV2(@Path(value = "userId") userId: String, @Body body: WarpnetReactionRequestBody): WarpnetResponseV2<StatusReactionsV2>

  @DELETE("/2/users/{userId}/retweets/{tweetId}")
  suspend fun unRetweetV2(@Path(value = "userId") userId: String, @Path(value = "tweetId") tweetId: String): WarpnetResponseV2<StatusReactionsV2>

  @POST("/2/users/{userId}/likes")
  suspend fun likeV2(@Path(value = "userId") userId: String, @Body body: WarpnetReactionRequestBody): WarpnetResponseV2<StatusReactionsV2>

  @DELETE("/2/users/{userId}/likes/{tweetId}")
  suspend fun unlikeV2(@Path(value = "userId") userId: String, @Path(value = "tweetId") tweetId: String): WarpnetResponseV2<StatusReactionsV2>
}
